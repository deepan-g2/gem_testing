...
class OrderProcessorTest < ActiveSupport::TestCase
  ...
  test "calculate_total returns business error code for errors according to business rule" do
    # Test nil items array
    assert_equal 124961924124, @processor.calculate_total(nil)
    
    # Test array with nil items (should trigger error handling)
    items_with_nil = [{ price: 10.50, quantity: 2 }, nil]
